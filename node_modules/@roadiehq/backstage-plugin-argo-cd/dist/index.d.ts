...
declare const EntityArgoCDContent: () => react.JSX.Element;
declare const EntityArgoCDOverviewCard: (props: {
    entity?: _backstage_catalog_model_index.Entity;
    extraColumns?: _backstage_core_components_index.TableColumn[];
}) => react.JSX.Element;
declare const EntityArgoCDHistoryCard: () => react.JSX.Element;
...
type ArgoCDAppDetails = t.TypeOf<typeof argoCDAppDetails>;
type ArgoCDAppDeployRevisionDetails = t.TypeOf<typeof argoCDAppDeployRevisionDetails>;
...
type ArgoCDAppList = t.TypeOf<typeof argoCDAppList>;
declare const argoCDServiceList: t.ArrayC<t.TypeC<{
    name: t.StringC;
    url: t.StringC;
    appName: t.UnionC<[t.ArrayC<t.StringC>, t.UndefinedC]>;
}>>;
type ArgoCDServiceList = t.TypeOf<typeof argoCDServiceList>;
...
declare const ARGOCD_ANNOTATION_APP_NAME = "argocd/app-name";
declare const ARGOCD_ANNOTATION_APP_SELECTOR = "argocd/app-selector";
declare const ARGOCD_ANNOTATION_APP_NAMESPACE = "argocd/app-namespace";
declare const ARGOCD_ANNOTATION_PROJECT_NAME = "argocd/project-name";
declare const ARGOCD_ANNOTATION_PROXY_URL = "argocd/proxy-url";

export { ARGOCD_ANNOTATION_APP_NAME, ARGOCD_ANNOTATION_APP_NAMESPACE, ARGOCD_ANNOTATION_APP_SELECTOR, ARGOCD_ANNOTATION_PROJECT_NAME, ARGOCD_ANNOTATION_PROXY_URL, type ArgoCDApi, ArgoCDApiClient, EntityArgoCDContent, EntityArgoCDHistoryCard, EntityArgoCDOverviewCard, type Options, argoCDApiRef, argocdPlugin, isArgocdAvailable, argocdPlugin as plugin };
